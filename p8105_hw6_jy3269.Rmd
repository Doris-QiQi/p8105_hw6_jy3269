...
\ \par
Next, I will fit my linear model using the cleaned data. First, I plan to fit the model using all the variables other than `bwt` (the response variable) as predictors to build a full model. Then I will use the step-wise method to select significant variables backwards. The selected variables and the response variable build up my regression model.
